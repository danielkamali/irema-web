          ...
          <svg key={i} width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{flexShrink:0}}>
            <defs>
              {half && <linearGradient id={`half${i}`} x1="0" x2="1" y1="0" y2="0">
                <stop offset="50%" style={{ stopColor: 'var(--star, #E8B800)' }}/>
                <stop offset="50%" style={{ stopColor: 'var(--border, #d4d4d4)' }}/>
              </linearGradient>}
            </defs>
            <polygon
              points="12,2 15.09,8.26 22,9.27 17,14.14 18.18,21.02 12,17.77 5.82,21.02 7,14.14 2,9.27 8.91,8.26"
              style={{
                fill: filled ? 'var(--star, #E8B800)' : half ? `url(#half${i})` : 'var(--border, #d4d4d4)',
                stroke: filled || half ? 'var(--star, #D4A000)' : 'var(--border-2, #c0c0c0)',
              }}
              strokeWidth="0.5"
            />
          </svg>
